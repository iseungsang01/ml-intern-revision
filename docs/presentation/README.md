...
| `KSTAR_CES_중간발표_v0.1.pptx` | PowerPoint, 23 슬라이드 (16:9) | **중간발표 v0.1 (역사 기록)** — 2026-07-30 원자핵공학과 대학원 내부 발표(20분)에서 실제로 쓴 손 편집판(`중간 보고_final.pptx`). W = 4·held 포함 시대의 잠정 수치이므로 **인용 금지**(§8v); 손 편집 내용은 `build_pptx_20min.py`에 반영돼 있고, 이 파일은 발표 당시 원본 보존용(2026-08-16 복원) |
